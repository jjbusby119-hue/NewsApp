...
class ArticleSerializer(serializers.ModelSerializer):
    ...
    journalist_authors = serializers.StringRelatedField(many=True, read_only=True)
    ...
    class Meta:
        ...
        read_only_fields = ['id', 'author', 'published_at', 'approved', 'journalist_authors']


class NewsletterSerializer(serializers.ModelSerializer):
    """Serializer for Newsletter with nested journalist authors."""
    journalist_authors = JournalistSerializer(many=True, read_only=True)
    ...
    class Meta:
        ...
        read_only_fields = ['id', 'author', 'created_at', 'description', 'journalist_authors']
